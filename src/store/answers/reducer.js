 ...
 *   @example
 *    //One possible instance of AnswersRD
 *    answersRD: {
 *    isLoading: true,
 *    isError: false,
 *    errorMessage: '',
...
/**
 *   @constant
 *   @type {module:answers/reducer~AnswersRD}
 *   @default
 */
const initialState = {
  isLoading: true,
...
/**
 *   @function getAnswers
 *   @description Get array of zero or more strings representing answers to one question for a given question_code
 *   @param {module:answers/reducer~AnswersRD} state - local slice of global state, @see {@link module:answers/reducer~AnswersRD|Type Definition}
 ...
 *   @param {module:answers/reducer~AnswersRD} state - local slice of global state, @see {@link module:answers/reducer~~AnswersRD|Type Definition}
 *   @param {Object} action
 *   @property {string} type - Expected to match one of the {@link module:answers/constants|Constants}
 *   @property {*} [payload]
 *   @return {module:answers/reducer~AnswersRD}
 */
